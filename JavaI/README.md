...
## Çfarë realizova
Krijova faqen e pasaportës digjitale për kandidatin udhërrëfyes të kampusit Agon Selimi. Projekti përmban tre faqe HTML (`index.html`, `rreth.html` dhe `kontakt.html`) që lidhen me njëra-tjetrën me lidhje relative, si dhe skedarin `style.css` për stilim.
...
- **Hyrje:** Klikimi te "Rreth Agonit" nga `index.html`
